<template>
	<view class="mix-botoom-operation row">
		...
		<view class="btn-group row">
			<view class="btn center" @click="onOprationClick('cart')"><text>加入购物车</text></view>
			<view class="btn center" @click="onOprationClick('buy')"><text>立即购买</text></view>
		</view>
...
<script>
import { changeFavorite } from '@/api/favorite.js';
/**
 * 商品详情页 底部操作菜单
 */
export default {
