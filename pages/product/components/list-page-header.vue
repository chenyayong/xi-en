<template>
	<view class="mix-page-header">
		...
		>
			<view class="btn center"><text class="mix-icon icon-xiangzuo" @click="navBack"></text></view>
			<view class="search-wrap center" :class="{ 'has-keyword': keyword }" :style="{ height: customHeight + 'px' }" @click="navToSearch">
