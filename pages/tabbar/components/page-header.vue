<template>
	<view class="mix-page-header">
		...
		>
			<view class="btn center" @click="navTo('/pages/notice/notice', { login: true })">
				<text class="mix-icon icon-xiaoxi"></text>
				<view class="msg"></view>
			</view>
			<view class="search-wrap center" :style="{ height: customHeight + 'px' }" @click="navTo('/pages/search/search', { login: true })">
				<text class="mix-icon icon-sousuo"></text>
				<text>输入关键字搜索</text>
			</view>
			<!-- #ifndef MP -->
			<!-- <view class="btn center" @click="scanCode"><text class="mix-icon icon-saoma"></text></view> -->
