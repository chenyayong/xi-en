<template>
	<view class="app column">
		...
		<!-- <view class="cell row b-b">
			...
			<view v-if="switchDisabled" class="loading"><mix-icon-loading size="32rpx" color="#ff536f"></mix-icon-loading></view>
		...
		<view class="cell row b-b" @click="checkVersion">
			...
			<view class="row" @click.stop.prevent="stopPrevent"><version-update ref="versionUpdate"></version-update></view>
			<text class="mix-icon icon-you"></text>
		</view>
		<!-- #endif -->
