<template>
	<view>
		<view class="list" :class="{show: showAll}">
			...
			<view v-for="(item, index) in list" :key="index" class="item row b-b" @click="navTo('/pages/product/detail?id='+item.id)"> 
				<!-- <image class="pic" :src="item.image" mode="aspectFill"></image> -->
				<image class="pic" :src="domain + item.thumb" mode="aspectFill"></image>
